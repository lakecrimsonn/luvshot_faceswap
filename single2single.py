...
# User should have to choose background image and source image

def single2single(background_img_path, source_img_path):
    ...
    # check gender
    for src in source_aligned_img:
        if (src[2] == 0):
            female = source_aligned_img
            print('the face of source image is a female')
        else:
            male = source_aligned_img
            print('the face of source image is a male')
    ...
    for idx, background in enumerate(background_aligned_img):
        print('checking background face gender, idx: ', idx, ' gender: ', background[2])
        if(background[2] == 0):
...
if __name__ == '__main__':
    # user background image, user single image
    single2single('data/origin.jpg', 'data/zzan.png')